      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '48px 24px 80px' }}>
        ...
        <div style={{
          ...
          <p style={{ fontSize: 13, color: '#FFFFFF', margin: 0, lineHeight: 1.8 }}>
            <span style={{ fontFamily: "'Playfair Display', 'Noto Serif JP', Georgia, serif", fontSize: 18, fontWeight: 700 }}>3</span>つの問いに答えるだけで、あなただけの才覚領域が明らかになります
          </p>
        </div>
              ...
              <div key={item.num} style={{ marginBottom: qi < 2 ? 28 : 0 }}>
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12, marginBottom: 10 }}>
                  <span style={{
                    ...
                    color: '#FFFFFF', fontSize: 11, fontWeight: 700, flexShrink: 0, marginTop: 2,
                  }}>{item.num}</span>
                  <p style={{
